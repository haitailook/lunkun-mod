...
public class Moditems {
    ...
    public static final Item ANGRY_HAHA_AXE=registerModItems("angry_haha_axe",new AxeItem(ModToolMaterial.LUNKUN_INGOT,6,-3,new FabricItemSettings()));
    public static final Item ANGRY_HAHA_PICKAXE=registerModItems("angry_haha_pickaxe",new PickaxeItem(ModToolMaterial.LUNKUN_INGOT,2,(float)-2.8,new FabricItemSettings()));
    public static final Item ANGRY_HAHA_SHOVE=registerModItems("angry_haha_shove",new ShovelItem(ModToolMaterial.LUNKUN_INGOT,(float)2.5,-3,new FabricItemSettings()));
    public static final Item ANGRY_HAHA_HOE=registerModItems("angry_haha_hoe",new HoeItem(ModToolMaterial.LUNKUN_INGOT,-4,0,new FabricItemSettings()));
    public static final Item ANGRY_HAHA_SWORD=registerModItems("angry_haha_sword",new SwordItem(ModToolMaterial.LUNKUN_INGOT,4,(float) -2.4,new FabricItemSettings()));
